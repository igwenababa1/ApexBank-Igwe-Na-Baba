...
import { ApexBankLogo, EyeIcon, EyeSlashIcon, LockClosedIcon, PlusCircleIcon } from './Icons';
    ...
    <>
      <div className="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="lg:col-span-1 space-y-8">
          {/* Card Visual */}
          <div className={`relative w-full max-w-md mx-auto p-6 rounded-2xl text-white shadow-digital transition-all duration-500 transform-style-3d hover:scale-105 ${card.isFrozen ? 'bg-slate-400 grayscale' : 'bg-primary'}`}>
          ...
          {/* Card Actions */}
          <div className="bg-slate-200 shadow-digital rounded-2xl p-6 space-y-4">

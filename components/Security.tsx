        ...
        <div className="bg-slate-200 rounded-2xl shadow-digital">
          ...
          <div className="p-6 divide-y divide-slate-300">
             <div className="py-4 flex justify-between items-center first:pt-0 last:pb-0">
                <div className="flex items-start space-x-4">
                    <FaceIdIcon className="w-6 h-6 text-slate-500 mt-0.5 flex-shrink-0"/>
                    <div>
                        <p className="font-medium text-slate-700">Device Authentication (Face ID / Fingerprint)</p>
                        <p className="text-sm text-slate-500">Sign in and authorize actions with biometrics.</p>
                    </div>
                </div>

...
import { LoanProduct, LoanApplication, LoanApplicationStatus, NotificationType } from '../types';
import { getLoanProducts } from '../services/geminiService';
import { SpinnerIcon, InfoIcon, CheckCircleIcon, CashIcon, XCircleIcon, BankIcon } from './Icons';
...
const ApplicationRow: React.FC<{ application: LoanApplication }> = ({ application }) => {
    const statusStyles = {
                ...
                <div className="bg-slate-200 rounded-2xl shadow-digital">
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm text-left">
                            ...
                            <tbody>
                                {loanApplications.map(app => <ApplicationRow key={app.id} application={app} />)}
                            </tbody>
                        </table>
                    </div>
                </div>

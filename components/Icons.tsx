...
// FIX: Add missing ExclamationTriangleIcon and KeypadIcon components.
// These icons are used in the SendMoneyFlow component but were not defined,
...
export const ShieldCheckIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.955a11.955 11.955 0 0018 0c0-1.061-.067-2.09-.188-3.045A12.02 12.02 0 0021 12.033c0-2.31-.62-4.44-1.688-6.348z" />
    </svg>
);
...
export const FingerprintIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A13.916 13.916 0 008 11a4 4 0 118 0c0 1.017-.07 2.019-.203 3m-2.118 6.844A21.88 21.88 0 0012 11c0-2.485-1.104-4.742-2.844-6.334M12 11c-.333-1.047-.738-2.05-1.226-3M9 12c.333-1.047.738-2.05 1.226-3m4.472 4.472a5.482 5.482 0 01-1.756 3.886M9.128 15.06a5.482 5.482 0 011.756-3.886" />
    </svg>
);

export const PlaidLogoIcon = ({ className }: { className?: string }) => (
    <svg className={className} viewBox="0 0 212 212" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="106" cy="106" r="106" fill="#0A2540"/>
        <path d="M105.88 135.2c-15.6 0-28.24-12.64-28.24-28.24s12.64-28.24 28.24-28.24c15.6 0 28.24 12.64 28.24 28.24 0 15.6-12.64 28.24-28.24 28.24zm0-62.76c-19.08 0-34.52 15.44-34.52 34.52s15.44 34.52 34.52 34.52c19.08 0 34.52-15.44 34.52-34.52S124.96 72.44 105.88 72.44z" fill="#fff"/>
        <path d="M140.4 135.2c-2.48 0-4.52-2.04-4.52-4.52V82.32c0-2.48 2.04-4.52 4.52-4.52s4.52 2.04 4.52 4.52v48.36c0 2.48-2.04 4.52-4.52 4.52z" fill="#fff"/>
    </svg>
);

export const FdicInsuredIcon = ({ className }: { className?: string }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M3 7V17H21V7L12 3L3 7ZM5 8.236L12 12L19 8.236V10H17V9H7V10H5V8.236ZM12 13.5L5 9.764V15H19V9.764L12 13.5Z" fill="currentColor"/>
    </svg>
);

export const PciDssIcon = ({ className }: { className?: string }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM11 16H13V18H11V16ZM11 6H13V14H11V6Z" fill="currentColor"/>
    </svg>
);

export const Soc2Icon = ({ className }: { className?: string }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M12 2L2 7V17L12 22L22 17V7L12 2ZM11 14.26L5.5 11.5V8.5L11 11.24V14.26ZM13 14.26V11.24L18.5 8.5V11.5L13 14.26Z" fill="currentColor"/>
    </svg>
);
...
export const VerifiedBadgeIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 24 24">
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1.03 15.42l-4.5-4.5 1.41-1.41L10.97 14l5.66-5.66L18.04 9.8l-7.07 7.07z"/>
  </svg>
);
...
export const BankIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21V3m0 0l-3.75 3.75M12 3l3.75 3.75M3 12h18M3 21h18M3 6.75h18M12 12.75a1.5 1.5 0 110-3 1.5 1.5 0 010 3z" />
    </svg>
);
...
export const NetworkIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6.75 6.75 0 000-13.5v13.5z" />
    </svg>
);
...
export const VisaIcon = ({ className }: { className?: string }) => (
    <svg className={className} viewBox="0 0 38 23" xmlns="http://www.w3.org/2000/svg">
        <path d="M35 0H3C1.3 0 0 1.3 0 3v17c0 1.7 1.4 3 3 3h32c1.7 0 3-1.3 3-3V3c0-1.7-1.4-3-3-3z" fill="#3953A5" />
        <path d="M15.4 17.5l-3.3-10.4H8.9l3.3 10.4h3.2zm11.3-4.2c.5-1 .7-2.2.3-3.3-.4-1.2-1.4-2-2.7-2.5-1.2-.4-2.6-.5-3.9-.2l-.4.1-1.3-4.4H15l3.2 10.4h2.9c.7 0 1.3-.3 1.6-.9.3-.6.3-1.3.1-1.9zm-5.7.8c.2-.2.4-.4.5-.6.5-.8.5-1.7 0-2.5-.2-.4-.6-.7-1-.9-.4-.2-.8-.3-1.3-.2l.7 2.4 1.1 1.8zm-9.3-6.5l-2.6 8.3-.2-.6c-.2-.7-.5-1.4-1-2-.5-.7-1.2-1.2-2-1.6-.7-.3-1.5-.5-2.2-.5-.3 0-.6 0-.9.1l.2-.7 1.3-4h3.2l-1 3.2c.4.1.7.3 1 .5.7.3 1.3.8 1.7 1.4.4.6.6 1.3.7 2l.3.9z" fill="#fff" />
    </svg>
);

export const MastercardIcon = ({ className }: { className?: string }) => (
    <svg className={className} viewBox="0 0 38 23" xmlns="http://www.w3.org/2000/svg">
        <path d="M35 0H3C1.3 0 0 1.3 0 3v17c0 1.7 1.4 3 3 3h32c1.7 0 3-1.3 3-3V3c0-1.7-1.4-3-3-3z" fill="#282828" />
        <circle cx="15" cy="11.5" r="6.5" fill="#EB001B" />
        <circle cx="23" cy="11.5" r="6.5" fill="#F79E1B" />
        <path d="M21 11.5c0 2.6-1.5 4.8-3.5 5.8-2 .9-4.5.9-6.5 0-2-1-3.5-3.2-3.5-5.8s1.5-4.8 3.5-5.8c2-1 4.5-1 6.5 0 2 1 3.5 3.2 3.5 5.8z" fill="#FF5F00" />
    </svg>
);
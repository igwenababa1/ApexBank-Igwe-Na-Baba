                ...
                <div className="lg:col-span-1 bg-slate-200 rounded-2xl shadow-digital">
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-4">
                        <div>
                            ...
                            <select id="country" value={countryCode} onChange={e => setCountryCode(e.target.value)} className="mt-1 w-full bg-slate-200 p-3 rounded-md shadow-digital-inset focus:ring-2 focus:ring-primary" required>
